...
const developers = [
  { name: 'Carry Anna', imgSrc: dpsample, description: 'ako ang lider sa mga wakwak ,wa koy tog di sa sig code pero tungod sa ako alter ego nga si god Anna' },
  ...
  { name: 'idol nakos Anna', imgSrc: marbench, description: 'idol nako si anna mao ng akong programming langguage gigamit kay bisaya developed by jimmy neutron' },
